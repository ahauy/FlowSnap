# Functional Specification: Stage Manager Multi-Window Auto-Grouping (US-WORK-018)
...
- **`REQ-SMA-001` (Stage Manager State Detection)**:
  ...
  - _Derived from_: `US-WORK-018`, `ASM-SMA-003`, `BR-SMA-001`.
...
- **`REQ-SMA-002` (Anchor App Activation)**:
  ...
  - _Derived from_: `US-WORK-018`, `ASM-SMA-001`, `BR-SMA-002`.
...
- **`REQ-SMA-003` (Secondary Window Placement & `kAXRaiseAction` Staging)**:
  ...
  - _Derived from_: `US-WORK-018`, `ASM-SMA-001`, `BR-SMA-003`.
...
### `US-WORK-018-01`: Multi-Window Restore with Stage Manager Active
...
### `US-WORK-018-02`: Multi-Window Restore with Stage Manager Inactive
...
### `US-WORK-018-03`: Single-App Workspace with Stage Manager Active
...
### `US-WORK-018-04`: Secondary App Hidden (Cmd+H)
