...
### Q5. Conservation rule: `unverifiable` gộp (a) hay tách presentation (b)?
- **Ảnh hưởng tới**: §2.4 conservation rule, §5.6 RestoreSummary extension, §6.3 headline logic, §14 Open questions #2 (liên quan Q1)
- **Khuyến nghị của spec**: (b) — tách thành `unverifiable` (missing element) + `movedButNotPresented` (presentation nil)
- **Vì sao**: Proposal `GiaiPhap.md` §12 đi theo (b); thông tin trung thực hơn
- **Nếu KHÔNG theo khuyến nghị thì sao**: (a) gộp → `unverifiableCount` bao gồm cả 2 loại, banner không phân biệt được
- [ ] Duyệt theo khuyến nghị (tách)
- [ ] Chọn phương án khác: ___________
...
**15 câu hỏi** (đã khử trùng từ 32 chỗ nhắc trong file v4):

| Tier | Số câu | Ảnh hưởng |
|---|---|---|
| A (data model) | 3 (Q1, Q2, Q3) | SkipReason / Category / mapping — đụng model nhiều Phase |
| B (structural) | 7 (Q4, Q5, Q6, Q7, Q8, Q9, Q10, Q11) | 1–2 Phase, structural |
| C (UI/option) | 5 (Q12, Q13, Q14, Q15, Q16, Q17) | UI / option nhỏ |
