// contracts/LaunchEvent.swift
// Standalone stub for the observation-event payload contract.
// Domain layer (Sendable, no AppKit, no ApplicationServices).
//
// US-WORK-013 / spec.md §6 / data-model.md §1.2.
